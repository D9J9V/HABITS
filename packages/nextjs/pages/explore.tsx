    ...
    >
      <div>
        ...
        <p className="mt-4 max-w-[750px] text-lg text-muted-foreground sm:text-xl">
          An application boilerplate built with a modern stack. Simple to get started building your first social app.
          Leveraging ShadCN, Lens Protocol, Next.js, and WalletConnect.
        </p>
      </div>
      ...
      <div className="mt-[70px] flex ml-2">
        ...
        <div className="ml-4">
          <Button
            ...
            className={`${dashboardType !== "recommendation algorithms" ? "opacity-50" : ""}`}
          >
                      ...
                      <div>
                        <img
                          className={cn(`
                            ...
                            `)}
                          src={
                            publication.__typename === "Post" ? publication.metadata?.asset?.image?.optimized.uri : ""
                          }
                        />
                        <ReactMarkdown
                          className="
